...
public class ReportsPanel extends JPanel {
    ...
    public ReportsPanel(DonorService donorService) {
        ...
        byGroupBtn.addActionListener(e -> showReport(donorService.countDonorsByBloodGroup()));
        byCityGroupBtn.addActionListener(e -> showReport(donorService.countDonorsByCityAndBloodGroup()));
    }
